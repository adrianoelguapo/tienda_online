        ...
        <main class = "container-fluid login-main my-5">
            ...
            <div class = "row justify-content-center">
                ...
                <div class = "col-12 col-md-8 col-lg-6">
                    ...
                    <h2 class = "text-center mb-2 login-title">Sign Up</h2>

                    <p class = "text-center mb-4 login-text">Already have an account? <a href = "login.php" class = "login-link ms-2 text-dark text-decoration-none">Log In here.</a></p>

                    <form class = "login-form" method = "POST" action = "sign-up(back).php">
